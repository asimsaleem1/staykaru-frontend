...
const MainStackNavigator = () => {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: true }}>
      ...
      <Stack.Screen 
        name="EditProfile" 
        component={EditProfileScreen}        options={{ title: 'Edit Profile' }}
      />
      <Stack.Screen 
        name="ChangePassword"
      ...
      <Stack.Screen
        ...
        component={AccommodationDetailScreen}        options={{ title: 'Accommodation Details' }}
      />
      <Stack.Screen 
        name="BookingForm"
      ...
      <Stack.Screen 
        name="Payment" 
        component={PaymentScreen}        options={{ title: 'Payment' }}
      />
      <Stack.Screen 
        name="ReviewForm"
      ...
      <Stack.Screen
        name="AddProperty" 
        component={AddPropertyScreen}        options={{ title: 'Add Property' }}
      />
      <Stack.Screen 
        name="EditProperty"
      ...
      <Stack.Screen
        name="AddMenuItem" 
        component={AddMenuItemScreen}        options={{ title: 'Add Menu Item' }}
      />
      <Stack.Screen 
        name="EditMenuItem"
      ...
      <Stack.Screen
        name="CitiesList" 
        component={CitiesListScreen}        options={{ title: 'Cities' }}
      />
      <Stack.Screen 
        name="CityDetail"
      ...
      <Stack.Screen
        ...
        component={LandlordPaymentHistoryScreen}        options={{ title: 'Payment History' }}
      />
      <Stack.Screen 
